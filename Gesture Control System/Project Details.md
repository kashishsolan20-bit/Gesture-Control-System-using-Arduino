...
<p align="left">
  <img src="Images/Arduino.webp" alt="Arduino UNO" width="450"/>
</p>
...
<p align="left">
  <img src="Images/sensor.jpg" alt="Ultrasonic Sensor" width="400"/>
</p>
...
### Jumper Wires
<p align="left">
  <img src="Images/wires.jpg" alt="Jumper Wires" width="200"/>
</p>
A jumper wire is an electric wire that connects remote electric circuits used for printed circuit boards. By attaching a jumper wire on the circuit, it can be short-circuited and short-cut (jump) to the electric circuit. For connecting components together.

### USB Cable
<p align="left">
  <img src="Images/Usb.png" alt="USB Cable" width="200"/>
</p>
They offer universal compatibility, meaning one cable type can work across many brands and devices. USB cables also provide fast data transfer and efficient charging, making them a practical everyday essential. For power supply and data transfer
